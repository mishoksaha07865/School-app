...
const AdmitFormPage = () => {
  return (
    <div className="lg:w-[70%] w-[96%] mx-auto min-h-[100vh]  m-2">
        ...
        <h2 className="p-3 text-2xl flex flex-col justify-center items-center text-gray-900 w-[100%] my-4 rounded-lg"><span>ভর্তি ফরম</span><Image src={"/icon-image.png"} alt="icon_image" width={100} height={100}/></h2>
        <div className="">
